        ...
        foreach ($paged as $g) {
            ...
            $data[] = [
                ...
                'hotel' => '<span 
                                ...
                                title="'.esc($g['hotel_name']).'"
                            >' 
                            .esc(mb_substr($g['hotel_name'],0,13)).'...'.
                            '</span>',
                'worker' => $workerCount,
                'job' => 'Week '.$week.' / '.$year,
                ...
                'action' => '
                    <a href="'.base_url('/admin/invoices/create-week/'.$g['week_key'].'/'.$g['hotel_id']).'" class="btn btn-sm btn-primary">Create Invoice</a>'
            ];
        }
