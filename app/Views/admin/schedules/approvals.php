                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post"
                                                              ...
                                                              class="d-inline">
                                                            <?= csrf_field() ?>
                                                            <button class="btn btn-sm btn-success" data-bs-toggle="tooltip" data-bs-placement="top"data-bs-custom-class="tooltip-success" title="Approve">
                                                        ...
                                                        <form method="post"
                                                              ...
                                                              class="d-inline">
                                                            <?= csrf_field() ?>
                                                            <button class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"data-bs-custom-class="tooltip-danger" title="Reject">
                                                                <i class="ti ti-x"></i>
                                                            </button>
                                                        </form>
                                                    </td>
