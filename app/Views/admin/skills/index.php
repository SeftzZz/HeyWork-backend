						...
						<div class="container-xxl flex-grow-1 container-p-y">
						    <div class="card">
						        <div class="card-datatable table-responsive pt-0">
						            <table class="dtSkill table table-striped">
						                <thead>
						                    <tr>
						                        <th></th>
						                        <th>No.</th>
						...
						<script>
						    ...
						    'use strict';
						    $(function () {
						        let dt_tableSkill = $('.dtSkill'), dt_skill;
						        if (dt_tableSkill.length) {
						        	dt_skill = dt_tableSkill.DataTable({
					                	...
					                	responsive: true,
						                ajax: {
						                    url: "<?= base_url('admin/skills/datatable') ?>",
						                    type: "POST",
						                    data: d => {
									...
									$('div.head-label').html('<h5 class="card-title mb-0">Skills List</h5>');
						        }
						    });
							            ...
							            $.ajax({
							                ...
							                success(res) {
							                    if (res.status) {
							                        ...
							                        $('.dtSkill').DataTable().ajax.reload(null, false);
							                    } else {
							                        Swal.fire({
							                            icon: 'error',
							                            title: 'Failed',
