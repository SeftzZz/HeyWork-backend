            ...
            <div class="row p-sm-3 p-0">
              ...
              <div class="col-xl-6 col-md-12 col-sm-7 col-12">
                ...
                <table>
                  <tbody>
                    <tr>
                      <td class="pe-4">Total Claim:</td>
                      <td class="fw-medium">
                        Rp <?= number_format($invoice['amount'], 0, ',', '.') ?>
                      </td>
                    </tr>
                    <tr>
                      <td class="pe-4">Category:</td>
          ...
          <div class="table-responsive border-top">
            <table class="table m-0">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-nowrap">Workforce Expense</td>
                ...
                <tr>
                  <td colspan="3" class="align-top px-4 py-4">
                    <p class="mb-2 mt-3">
                      <span class="fw-medium">Generated By:</span>
                      <span><?= esc($invoice['hotel_name']) ?> Finance System</span>
                    </p>
                  ...
                  <td class="text-end pe-3 py-4">
                    ...
                    <p class="mb-2">Tax:</p>
                    <p class="mb-0 pb-3 fw-bold">Total Claim:</p>
                  </td>
          ...
          <div class="card-body mx-3">
            <div class="row">
              <div class="col-12">
                ...
                <span>
                  This invoice is submitted by <?= esc($invoice['hotel_name']) ?> 
                  to HeyWork for operational expense reimbursement.
                </span>
              </div>
            </div>
          </div>
