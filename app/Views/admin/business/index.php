										    ...
										    <div class="modal-content">
											    <form id="formEditHotel" enctype="multipart/form-data">
											        ...
											        <div class="modal-body">
											          	...
											          	<div class="row">
									                        <div class="col-md-6 mb-3">
									                            <label class="form-label" for="edit_hotel_name">Business Name</label>
		                ...
		                <script>
						    ...
						    $(function () {
						        ...
						        if (dt_tableHotel.length) {
						        	dt_hotel = dt_tableHotel.DataTable({
					                	...
					                	responsive: true,
						                ajax: {
						                    url: "<?= base_url('admin/business/datatable') ?>",
						                    type: "POST",
						                    data: d => {
						                ...
						                buttons: (sessionHotelId === 0) ? [
										    ...
										    {
										        text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-sm-inline-block">Add New Business</span>',
									...
									$('div.head-label').html('<h5 class="card-title mb-0">Business List</h5>');
						        }
						    });
							...
							$('#formAddHotel').on('submit', function (e) {
							    ...
							    Swal.fire({
							        ...
							        if (result.isConfirmed) {
							            $.ajax({
							                url: "<?= base_url('admin/business/store') ?>",
							                type: "POST",
							                data: formData,
							                processData: false,
							                contentType: false,
							...
							$(document).on('click', '.btn-edit', function () {
							    ...
							    $.post("<?= base_url('admin/business/get') ?>", {
							        id: id,
							...
							$('#formEditHotel').on('submit', function (e) {
							    ...
							    Swal.fire({
							        ...
							        if (result.isConfirmed) {
							            $.ajax({
									        url: "<?= base_url('admin/business/update') ?>",
									        type: "POST",
									        data: formData,
									        processData: false,
									        contentType: false,
							...
							$(document).on('click', '.btn-delete', function () {
							    ...
							    Swal.fire({
							        ...
							        if (result.isConfirmed) {
							            $.ajax({
							                url: "<?= base_url('admin/business/delete') ?>",
							                type: "POST",
							                dataType: "json",
							                data: {
							                    id: id,
